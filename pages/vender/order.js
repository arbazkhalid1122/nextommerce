  ...
  return (
    <div className="rounded-lg w-full">
            ...
            {filteredOrders.map((order) => (
              <tr key={order.id} className="border-b hover:bg-gray-100">
                ...
                <td className="p-2 flex items-center gap-2">
                  <img
                    src="https://images.unsplash.com/photo-1545127398-14699f92334b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aXRlbXN8ZW58MHx8MHx8fDA%3D"
                    alt="watch"
                    className="h-6"
                  />
                  <img
                    src="https://images.unsplash.com/photo-1536816579748-4ecb3f03d72a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjR8fGl0ZW1zfGVufDB8fDB8fHww"
                    alt="phone"
                    className="h-6"
                  />
                  <img
                    src="https://images.unsplash.com/photo-1587334106798-799c53ac09d3?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTE2fHxpdGVtc3xlbnwwfHwwfHx8MA%3D%3D"
                    alt="laptop"
                    className="h-6"
                  />
      ...
      <div className="flex justify-center mt-4">
        <button className="px-3 py-1 mx-1 bg-gray-800 text-white rounded">
          1
        </button>
